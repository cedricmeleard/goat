...
public class CharacterTests
{
    ...
    {
        // Arrange
        var frodo = Character.Create(Name.Parse("Frodo Baggins"), Race.Hobbit,
            new Weapon(WeaponName.Parse("Dard"), Damage.Parse(100)));
        ...
        action
            ...
            .WithMessage(
                "Cannot move Frodo Baggins from Mordor to Shire. Reason: There is no coming back from Mordor.");
    }
}